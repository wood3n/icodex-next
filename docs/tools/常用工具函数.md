---
title: utility
description: 'javascript function debounce(fn, interval) {   let timerId;   return function(...args) {     if (timerId) {       clearTimeout(timerId);     }'
keywords: ["防抖", "节流", "new", "partial", "函数偏函数", "curry", "函数柯里化", "复合函数compose"]
tags: ["防抖", "节流", "new", "partial", "函数偏函数"]
---
