...
description: 'typescript // 方法一 const person = [{ name: ''oxygen'', age: 20 }].find(item => item.age === 20) || {   name: '''',   age: 0, };'
keywords: ["es", "原始值类型", "原始值类型的表示", "null", "undefined", "字面量类型", "大写类型格式", "引用类型"]
tags: ["es", "原始值类型", "原始值类型的表示", "null", "undefined"]
---
